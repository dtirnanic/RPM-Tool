...
namespace RPM_Tool.Controllers
{
    public class BuildingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,LandlordId,UnitId,BuildingVendorId,MortgageEscrowId,BuildingUtilityId,ScheduledMaintenanceId")] Building building)
        {
